...
<video controls poster="/images/course/agent-loop.jpg" style="width: 100%; border-radius: 8px; margin: 1rem 0;">
...
![The core agent loop (static frame): Perceive the environment, Reason using the LLM, Act via tools, Update history, and Evaluate progress toward the goal. This cycle repeats for complex, multi-step tasks.](/images/course/agent-loop.jpg)
