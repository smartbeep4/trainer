  ...
  questions={[
    ...
    },
    {
      ...
      options: [
        ...
        { id: "b", text: "The tendency to prefer responses in certain positions (e.g., always first)" },
        { id: "c", text: "The tendency to prefer responses from the same model family" },
        { id: "d", text: "The tendency to give higher ratings to confident-sounding responses" }
      ],
      correctAnswer: "b",
    ...
    },
    {
      ...
      options: [
        ...
        { id: "c", text: "For calibrating your LLM judge and evaluating edge cases" },
    ...
    },
    {
      id: "q4",
      type: "multiple-choice",
      question: "What is the primary purpose of regression detection in evaluation pipelines?",
      options: [
    ...
    },
    {
      id: "q5",
      type: "multiple-choice",
      question: "What target agreement level (Cohen's kappa) should you aim for when calibrating an LLM judge against human ratings?",
      options: [
  ...
  parts={[
    {
      ...
      observePrompt: "What patterns emerge in the types of questions that are hardest to evaluate? Which categories need the most careful criteria?"
    },
    {
      id: "build-llm-judge",
      ...
      observePrompt: "Does your judge show any biases (length bias, format preference)? How consistent are ratings across similar inputs?"
    },
    {
      id: "calibration-plan",
      ...
      observePrompt: "What disagreements between human and LLM judges would be most concerning? How would you adjust the prompt based on disagreements?"
    },
    {
      ...
      observePrompt: "How sensitive should your regression detection be? What's worse: false positives blocking good changes or false negatives shipping regressions?"
    },
    {
      id: "pipeline-design",
      ...
      observePrompt: "How do you balance thoroughness vs. speed? What would make developers trust and use this pipeline versus ignore it?"
    }
  ]}
  successCriteria={[
    { id: "test-coverage", text: "Created 20 diverse test cases covering multiple difficulty levels and question types" },
    { id: "judge-implementation", text: "Built a multi-aspect LLM judge with clear evaluation criteria and rubrics" },
    { id: "calibration-plan", text: "Defined a concrete calibration plan with metrics and target thresholds" },
    { id: "regression-detection", text: "Implemented regression detection using both statistical tests and absolute thresholds" },
    { id: "pipeline-config", text: "Designed a complete pipeline with triggers, stages, and gates appropriate for real-world use" },
    { id: "cost-awareness", text: "Estimated costs and identified strategies to control expenses" }
  ]}
/>
...
**"MMLU: Measuring Massive Multitask Language Understanding"** - Hendrycks et al. (2021). Foundational paper for multi-domain knowledge evaluation.
[arxiv.org/abs/2009.03300](https://arxiv.org/abs/2009.03300)

**"Evaluating Large Language Models Trained on Code (HumanEval)"** - Chen et al. (2021). HumanEval benchmark for code generation.
[arxiv.org/abs/2107.03374](https://arxiv.org/abs/2107.03374)

**"HELM: Holistic Evaluation of Language Models"** - Liang et al. (2022). Comprehensive evaluation framework from Stanford.
[arxiv.org/abs/2211.09110](https://arxiv.org/abs/2211.09110)

**"Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena"** - Zheng et al. (2023). LLM judge reliability and biases.
[arxiv.org/abs/2306.05685](https://arxiv.org/abs/2306.05685)

**"Large Language Models are not Fair Evaluators"** - Wang et al. (2023). Position bias and other issues in LLM judges.
[arxiv.org/abs/2305.17926](https://arxiv.org/abs/2305.17926)

**Official Documentation**

**OpenAI Evals Framework** - Open-source framework for evaluating LLMs.
[github.com/openai/evals](https://github.com/openai/evals)

**Hugging Face Evaluate Library** - Comprehensive library for ML evaluation metrics.
[huggingface.co/docs/evaluate](https://huggingface.co/docs/evaluate)

**Practical Resources**

**LangSmith Evaluation Guide** - Practical guidance on evaluating LLM applications.
[docs.smith.langchain.com](https://docs.smith.langchain.com)

**"The LLM Evaluation Handbook"** - Eugene Yan. Practical insights from ML engineering experience.
[eugeneyan.com](https://eugeneyan.com/)

**Benchmark Leaderboards**

**Open LLM Leaderboard** - Hugging Face community benchmarks for open models.
[huggingface.co/spaces/HuggingFaceH4/open_llm_leaderboard](https://huggingface.co/spaces/HuggingFaceH4/open_llm_leaderboard)

**Chatbot Arena Leaderboard** - Human preference rankings from pairwise comparisons.
[lmsys.org/blog/2023-05-03-arena](https://lmsys.org/blog/2023-05-03-arena/)

**SWE-bench** - Real-world software engineering benchmarks.
[swe-bench.github.io](https://www.swe-bench.github.io/)
