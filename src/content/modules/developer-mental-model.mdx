...
<HandsOnExercise
  ...
  parts={[
    {
      ...
      observePrompt: "Where is it accurate? Where does it get details wrong? How confident does it sound in both cases?"
    },
    {
      ...
      observePrompt: "Does it acknowledge uncertainty? Does it hedge appropriately? Does it confabulate?"
    },
    {
      ...
      observePrompt: "Does the AI recognize and challenge the false premise? Or does it play along?"
    },
    {
      id: "reflection",
      title: "Reflection",
  ...
  successCriteria={[
    { id: "conducted-tests", text: "Conducted all three types of tests (familiar, uncertainty, misleading)" },
    { id: "documented-observations", text: "Documented specific observations for each part" },
    { id: "found-error", text: "Found at least one instance of AI being confidently wrong" },
    { id: "identified-pattern", text: "Identified at least one pattern in AI behavior" },
    { id: "written-reflection", text: "Written a reflection with actionable insights" }
  ]}
/>
