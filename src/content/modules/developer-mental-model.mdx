...
![The power tool metaphor: A developer using AI as a precise, high-powered instrument under careful human guidance and judgment, rather than letting the tool run unchecked.](/images/course/power-tool-metaphor.jpg)

*The central mental model of the course: AI is a powerful tool that requires skill, oversight, and understanding to use effectively.*
