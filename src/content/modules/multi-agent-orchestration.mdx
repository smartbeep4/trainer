...
![Multi-agent collaboration: An orchestrator coordinates specialized agents (researcher, coder, critic) that communicate and pass work products to solve a complex development task together.](/images/course/multi-agent-collaboration.jpg)

*Example architecture showing how multiple agents with distinct roles can work together more effectively than a single monolithic agent.*
