...
![End-to-end RAG pipeline: documents are chunked and embedded, stored in a vector database, relevant chunks are retrieved via semantic search, the prompt is augmented with that context, and the LLM produces a grounded answer.](/images/course/rag-pipeline.jpg)
