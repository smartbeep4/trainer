  ...
  questions={[
    {
      ...
      options: [
        { id: "a", text: "They learn to directly sample from the data distribution" },
        { id: "b", text: "They learn to reverse a gradual noise addition process" },
        { id: "c", text: "They use adversarial training between generator and discriminator" },
        { id: "d", text: "They compress images into discrete tokens for generation" }
      ],
      correctAnswer: "b",
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "CLIP directly generates images from text" },
        { id: "b", text: "CLIP learns a shared embedding space where text and images with similar meanings are close together" },
        { id: "c", text: "CLIP translates text into pixel values" },
        { id: "d", text: "CLIP provides a loss function that measures image quality" }
      ],
      correctAnswer: "b",
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "Higher image quality" },
        { id: "b", text: "Better text conditioning" },
        { id: "c", text: "Computational efficiency through operating on compressed representations" },
        { id: "d", text: "Simpler training objectives" }
      ],
      correctAnswer: "c",
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "Basic object recognition" },
        { id: "b", text: "Generating natural language responses" },
        { id: "c", text: "Precise spatial reasoning and counting" },
        { id: "d", text: "Processing images of different sizes" }
      ],
      correctAnswer: "c",
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "A technique for classifying generated images into categories" },
        { id: "b", text: "A method that amplifies conditioning by comparing conditional and unconditional predictions" },
        { id: "c", text: "A way to train diffusion models without labeled data" },
        { id: "d", text: "An approach for filtering out low-quality generations" }
      ],
      correctAnswer: "b",
